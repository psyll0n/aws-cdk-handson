...
class ApplicationStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, main_vpc: ec2.Vpc, **kwargs) -> None:
        ...
        # Adding stack-level tags to all resources in this stack. 
        # This will apply the tag "category: web-server" to all resources defined in this stack.
        ...
        # This tag will be added to all resources except EC2 instances,
        # demonstrating how to exclude specific resource types from tagging.
        Tags.of(web_server).add("subcategory", "side", 
                        exclude_resource_types=["AWS::EC2::Instance"],
                        priority=300)  # Higher priority to disallow tags overriding
        
        # Removing a specific tag from a resource. In this case, we remove the "subcategory" tag from the EC2 instance.
